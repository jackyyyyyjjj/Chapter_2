...
cur = sqlite.connect('appmonsta_app2018.sqlite')  # you can change the databse name here
conn = cur.cursor()

count = 0

with open('AppMonstaPlayStoreDetails20180813.json', encoding='utf-8') as f:
    count += 1
    while True:
        line = f.readline()
        count += 1
    ...
    # Load json object and print it out
        ...
        tablename = 'AppMonstaPlayStoreDetails20180813'
        date = "2018-08-13"
