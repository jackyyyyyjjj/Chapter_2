...
cur = sqlite.connect('appmonsta_app2019.sqlite')  # you can change the databse name here
conn = cur.cursor()

count = 0

with open('AppMonstaPlayStoreDetails20190812.json', encoding='utf-8') as f:
    count += 1
    while True:
        line = f.readline()
        count += 1
    ...
    # Load json object and print it out
        ...
        tablename = 'AppMonstaPlayStoreDetails20190812'
        date = "2019-08-12"
