...
cur = sqlite.connect('appmonsta_app2021.sqlite')  # you can change the databse name here
conn = cur.cursor()
...
for i in range(7):
    with open('AppMonstaPlayStoreDetails20210816.json', encoding='utf-8') as f:
        count += 1
        while True:
            line = f.readline()
            count += 1
        ...
        # Load json object and print it out
            ...
            tablename = 'AppMonstaPlayStoreDetails20210816'
            date='2021-08-16'
