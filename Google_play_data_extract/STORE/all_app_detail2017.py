...
cur = sqlite.connect('appmonsta_app2017.sqlite')  # you can change the databse name here
conn = cur.cursor()
...
with open('AppMonstaPlayStoreDetails20170814.json', encoding='utf-8') as f:
    count += 1
    while True:
        line = f.readline()
        count += 1
    ...
    # Load json object and print it out
        ...
        tablename = 'AppMonstaPlayStoreDetails20170814'
        date = "2017-08-14"
